    ...
    >
        <defs>
            <linearGradient id="sphereGradient" x1="5%" x2="5%" y1="0%" y2="15%">
                <stop stopColor="#373734Ca" offset="0%" />
                <stop stopColor="#242423ca" offset="50%" />
                <stop stopColor="#0D0D0Cca" offset="100%" />
            </linearGradient>
        </defs>
        ...
        <path d="M252.887 252.52C175.27 330.138 90.584 371.294 63.736 344.446c-26.849-26.85 14.307-111.536 91.924-189.153C233.276 77.677 317.962 36.521 344.81 63.37c26.85 26.848-14.307 111.534-91.923 189.15z" />
        <path d="M236.977 236.61c-75.908 75.91-159.11 115.779-185.837 89.053-26.726-26.727 13.143-109.928 89.052-185.837 75.908-75.908 159.11-115.777 185.836-89.05 26.727 26.726-13.143 109.928-89.051 185.836z" />
                ...
                for (let i = 0; i < pathLength; i++) {
                    animations.push(
                        anime({
                            ...
                            stroke: {
                                value: ["rgba(255, 181, 167, 1)", "rgba(80,80,80,.35)"],
                                duration: 500
                            },
                            translateX: [2, -4],
                            translateY: [2, -4],
